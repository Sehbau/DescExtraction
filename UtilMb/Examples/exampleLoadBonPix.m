...
[AASP  Nbon1]     = LoadBonAspPyr('../DescExtr/Desc/img1.BonAsp');
[APIX  Nbon2 SzM] = LoadBonPixPyr('../DescExtr/Desc/img1.BonPix');
...
for l = 1:nLev
    ...
    for b = 1:nBon
        ...
        if Asp.ArePix(b)<nPxMap*0.01, 
                continue; end % skip small ones
